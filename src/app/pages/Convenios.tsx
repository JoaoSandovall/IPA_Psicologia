                  ...
                  >
                    ...
                    <div className="bg-white/50 border border-black/5 rounded-sm p-2 lg:p-6 shadow-sm">
                      {group.items.map((item, i) => (
                        <div
                          key={item}
                          className={`group flex items-center py-4 px-4 transition-all duration-300 cursor-default rounded-sm hover:bg-[#4A7259]/5 hover:pl-6 ${i < group.items.length - 1 ? 'border-b border-black/5' : ''}`}
                        >
                          <div className="w-1.5 h-1.5 rounded-full bg-[#4A7259]/30 group-hover:bg-[#C97B52] transition-colors duration-300 shrink-0 mr-4" />
