              ...
              <div className="bg-white w-full rounded-2xl p-8 md:p-14 shadow-xl shadow-black/5 border border-black/5 flex flex-col">
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-4 pt-8 border-t border-black/5">
                  <a 
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 text-[10px] md:text-xs font-bold uppercase tracking-[0.15em] rounded-full transition-all duration-300 shadow-md hover:shadow-lg bg-[#4A7259] hover:bg-[#3A5E47] text-[#F7F5F1]"
                    style={{ fontFamily: "'Lato', sans-serif" }}
                  >
                  ...
                  <button 
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 text-[10px] md:text-xs font-bold uppercase tracking-[0.15em] rounded-full border transition-all duration-300 bg-transparent text-[#4A7259] border-[rgba(74,114,89,0.3)] hover:bg-[rgba(74,114,89,0.05)] hover:border-[#4A7259]"
                    style={{ fontFamily: "'Lato', sans-serif" }}
                  >
